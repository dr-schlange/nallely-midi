from nallely import LFO, DeviceNotFound, VirtualDevice, VirtualParameter, on
...
class LISA(VirtualDevice):
    ...
    inputs:
    # * wt1_timbre_cv [20, 1000] init=258 <any>: timbre for wavetable 1
    # * wt2_timbre_cv [20, 1000] init=258 <any>: timbre for wavetable 2
    # * wt3_timbre_cv [20, 1000] init=258 <any>: timbre for wavetable 3
    # * wt4_timbre_cv [20, 1000] init=258 <any>: timbre for wavetable
