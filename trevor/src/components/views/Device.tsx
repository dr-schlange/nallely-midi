...
import type { MidiDeviceSection } from "../../model";
				...
				<div className="device-side left">
					{leftSections.map((section, index) => {
						...
						return (
							...
							>
								<div className="device-section-box" title={section.name} />
								<span className="device-section-name left">
				...
				<div className="device-side right">
					{rightSections.map((section, index) => {
						...
						return (
							...
							>
								<span className="device-section-name right">
									{generateAcronym(section.name)}
								</span>
								<div className="device-section-box" title={section.name} />
							</div>
